...
if __name__ == "__main__":
    ...
    parser.add_argument("-out", "--out_file", dest="out_file",
                        default="/home1/liyue/Lee_NQG/predict/DRCD/generated_26.txt",
                        help="output file to compare")
    parser.add_argument("-src", "--src_file", dest="src_file",
                        default="/home1/liyue/Lee_NQG/predict/DRCD/gold_26.txt", help="src file")
    parser.add_argument("-tgt", "--tgt_file", dest="tgt_file",
                        default="/home1/liyue/Lee_NQG/predict/DRCD/gold_26.txt", help="target file")
